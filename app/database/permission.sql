...
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Profissionais', 'ProfissionaisCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='ProfissionaisCustomForm');

INSERT INTO system_program (id, name, controller)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Servicos', 'ServicosCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='ServicosCustomForm');

INSERT INTO system_program (id, name, controller)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Vinculo Servicos', 'VinculoServicosCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='VinculoServicosCustomForm');

INSERT INTO system_program (id, name, controller)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Atendimentos', 'AtendimentosCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='AtendimentosCustomForm');
...
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='ProfissionaisCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='ProfissionaisCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='ServicosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='ServicosCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='VinculoServicosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='VinculoServicosCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='AtendimentosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='AtendimentosCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 2,
       (select id from system_program where controller='ProfissionaisCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=2 AND system_program_id=(select id from system_program where controller='ProfissionaisCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 2,
       (select id from system_program where controller='ServicosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=2 AND system_program_id=(select id from system_program where controller='ServicosCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 2,
       (select id from system_program where controller='VinculoServicosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=2 AND system_program_id=(select id from system_program where controller='VinculoServicosCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 2,
       (select id from system_program where controller='AtendimentosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=2 AND system_program_id=(select id from system_program where controller='AtendimentosCustomForm'));

--- Agenda programs
INSERT INTO system_program (id, name, controller)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Agenda profissional', 'AgendaProfissionalCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='AgendaProfissionalCustomForm');

INSERT INTO system_program (id, name, controller)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Agendamentos', 'AgendamentosCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='AgendamentosCustomForm');

INSERT INTO system_program (id, name, controller)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Agendar', 'AgendarCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='AgendarCustomForm');

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='AgendaProfissionalCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='AgendaProfissionalCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='AgendamentosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='AgendamentosCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='AgendarCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='AgendarCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 2,
       (select id from system_program where controller='AgendaProfissionalCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=2 AND system_program_id=(select id from system_program where controller='AgendaProfissionalCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 2,
       (select id from system_program where controller='AgendamentosCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=2 AND system_program_id=(select id from system_program where controller='AgendamentosCustomForm'));

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 2,
       (select id from system_program where controller='AgendarCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=2 AND system_program_id=(select id from system_program where controller='AgendarCustomForm'));

--- Caixa programs
INSERT INTO system_program (id, name, controller)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_program b), 'Movimento Caixa', 'MovimentoCaixaCustomForm'
WHERE NOT EXISTS (SELECT 1 FROM system_program WHERE controller='MovimentoCaixaCustomForm');

INSERT INTO system_group_program (id, system_group_id, system_program_id)
SELECT (SELECT coalesce(max(id),0)+1 FROM system_group_program b), 1,
       (select id from system_program where controller='MovimentoCaixaCustomForm')
WHERE NOT EXISTS (SELECT 1 FROM system_group_program WHERE system_group_id=1 AND system_program_id=(select id from system_program where controller='MovimentoCaixaCustomForm'));
